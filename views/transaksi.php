...
<?php while($join_tbl = mysqli_fetch_assoc($querys)):?>
  ...
  <!-- <a href="statustransaksi.php?id=<?= $join_tbl['id'] ?>&status=lunas" class="btn btn-info mb-2 col-md-2 ml-3">Lunas</a> -->
