...
mysqli_query($conn, "UPDATE order_masuk SET nama_pemesan = '$pemesan', no_wa = '$wa', alamat_jemput = '$alamat', jenis_layanan = '$layanan', jenis_item = '$item', tanggal_pesan = '$pesan', tanggal_selesai = '$selesai' WHERE id = $id");
